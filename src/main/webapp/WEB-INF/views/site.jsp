...
<c:url var="css" value='/assets/css' />
<c:url var="img" value='/assets/images' />
<c:url var="js" value='/assets/js' />
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
						...
						<div class="navigation">
							<ul>
								...
								<c:forEach var="cat" items="${cat_list}">
									...
									<a href="categoryDeleteAction?no=${cat.catNo}" onclick="return confirm('삭제하시겠습니까?');"><span class="glyphicon glyphicon-remove"></span></a>
									</li>
								</c:forEach>
							</ul>
							<ul>
																...
																<div class="input-group">
																	...
																	<input type="text" name="quant[1]"
																		...
																		<button
																			...
																			location.href='siteDeleteAction?linkNo=${site.linkNo}&catNo=<c:out value="${param.no}" />'}"
																			type="button">
